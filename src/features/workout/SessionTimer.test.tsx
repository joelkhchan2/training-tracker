...
describe('SessionTimer', () => {
  it('renders elapsed since startedAt and ticks', () => {
    ...
    render(<SessionTimer startedAt="2026-07-23T00:00:00Z" onOpen={vi.fn()} />)
  ...
  it('renders as a button labeled "Adjust workout timer" and calls onOpen when clicked', () => {
    const onOpen = vi.fn()
    render(<SessionTimer startedAt="2026-07-23T00:00:00Z" onOpen={onOpen} />)
    const button = screen.getByRole('button', { name: 'Adjust workout timer' })
